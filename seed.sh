...
npx hurl invoke person person_create "{\"id\":\"1-100-100\", \"name\": \"John Doe\"}" -u admin
...
npx hurl invoke person person_create "{\"id\":\"1-100-101\", \"name\": \"Carl Jr\"}" -u admin
...
npx hurl invoke person person_create "{\"id\":\"1-100-102\", \"name\": \"Alfred\"}" -u admin
