...
const CAUSE_NODE_PROPS = { group: NodeType.CAUSE, nodeVal: NodeValue.CAUSE, color: NodeColor.ORANGE };
const ASSET_NODE_PROPS = { group: NodeType.ASSET, nodeVal: NodeValue.ASSET, color: NodeColor.YELLOW };
const TRANSACTION_NODE_PROPS = { group: NodeType.TRANSACTION, nodeVal: NodeValue.TRANSACTION, color: NodeColor.GREEN };
