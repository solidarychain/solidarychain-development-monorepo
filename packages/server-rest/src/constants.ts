...
export const appConstants = {
  ...
  API_OPERATION_GET_PARTICIPANT,
  API_OPERATION_GET_ALL_PARTICIPANTS,
  API_OPERATION_REGISTER_PARTICIPANT,
  API_OPERATION_GET_PERSON,
  API_OPERATION_GET_ALL_PERSONS,
  API_OPERATION_CREATE_PERSON,
  API_OPERATION_ADD_PERSON_ATTRIBUTE,
  API_OPERATION_ADD_PERSONS_BY_ATTRIBUTE,
